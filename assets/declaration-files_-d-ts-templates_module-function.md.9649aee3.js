import{_ as s,c as n,o as a,a as l}from"./app.2c29dd5e.js";const u=JSON.parse('{"title":"Module: Function","description":"","frontmatter":{},"headers":[],"relativePath":"declaration-files/-d-ts-templates/module-function.md"}'),p={name:"declaration-files/-d-ts-templates/module-function.md"},e=l(`<h1 id="module-function" tabindex="-1">Module: Function <a class="header-anchor" href="#module-function" aria-hidden="true">#</a></h1><p>\u4F8B\u5982\uFF0C\u5F53\u4F60\u60F3\u8981\u4F7F\u7528 JavaScript \u4EE3\u7801\u65F6\uFF0C\u5B83\u770B\u8D77\u6765\u50CF\uFF1A</p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki"><code><span class="line"><span style="color:#89DDFF;">import</span><span style="color:#A6ACCD;"> greeter </span><span style="color:#89DDFF;">from</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">super-greeter</span><span style="color:#89DDFF;">&quot;</span><span style="color:#89DDFF;">;</span></span>
